...
public class MSB extends Verticle {
	...
	private void init() {
		...
		databaseInstances[0] = "ec2-52-87-226-205.compute-1.amazonaws.com";
		databaseInstances[1] = "ec2-54-173-133-133.compute-1.amazonaws.com";
	...
	private String retrieveDetails(String targetID) {
		...
		try{
			 ...
			 */
			int start = Integer.parseInt(targetID) - 25;
			if(start<=0){
				start=1;
			}
			int end =  Integer.parseInt(targetID) + 25;
